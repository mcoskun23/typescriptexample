		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comntttypescriptexample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comntttypescriptexample-display": {
								"semanticObject": "comntttypescriptexample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ntt.typescriptexample",
									"url": sap.ui.require.toUrl("com/ntt/typescriptexample")
								}
							}
						}
					}
